...
public class QuestionFetcher {
  ...
  public QuestionFetcher(QuestionClient questionClient, QuestionMapper questionMapper,
  ...
  @Retryable(retryFor = {
      FeignException.FeignClientException.TooManyRequests.class }, maxAttempts = 3, backoff = @Backoff(delay = 1000, multiplier = 2.0, maxDelay = 5000))
